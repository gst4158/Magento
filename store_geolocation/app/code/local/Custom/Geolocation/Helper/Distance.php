...
class Custom_Geolocation_Helper_Distance extends Mage_Core_Helper_Abstract {
    ...
    */
    public function custom_getStoreUserDist($user, $stores) {
        ...
        $detail['user_details'] = Mage::helper('custom_geolocation')->custom_getUserDetails($user);
    ...
    * Returns the distance from each store the user is from
    */
    public function custom_selectiveRange($array, $states, $country = 'US', $type) {
    ...
    */
    public function custom_closestStoreNiceName($stores, $distance = 100) {
        $inRange = array();
